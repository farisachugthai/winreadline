...
class Keys(str, Enum):
    ...
    strings.
    """
    # IntEnum would be hard to work with but probably less ambiguous than strings.
    # Also note that pt makes no distinction between shifted keys and not.
    value: str
